...
use super::{
    utils,
    vector::{vec2::Vec2, vec3::Vec3, VecMethods},
...
impl OpenSimplexNoise3D {
    ...
    fn inside_tetrahedron_at_0_0_0(
        ...
        // contribute. This depends on the closest two tetrahedral vertices,
        // including (0, 0, 0)
        let value =
            Self::determine_lattice_points_including_0_0_0(in_sum, score, point, |x, y, z| {
                contribute(x, y, z)
            });
    ...
    fn inside_tetrahedron_at_1_1_1(
        ...
        // including (1, 1, 1)
        let value =
            Self::determine_lattice_points_including_1_1_1(in_sum, score, point, |x, y, z| {
                contribute(x, y, z)
            });
    ...
    fn determine_further_side(ins: Vec3<f64>) -> (Vec2<bool>, Vec2<i32>) {
        let (score, mut point, mut is_further_side) = Self::decide_between_points(ins);
