...
//
// use super::{
// DynamicAliasMethodStackSampler, super::PositiveF64Decomposed,
...
// 0_u8,
// DynamicAliasMethodSampler::<u8>::decompose_weight(PositiveF64::new(6.0 /
// 12.0).unwrap()) .mantissa,
// );
//
// for i in 1..6 {
// assert_eq!(
...
// const N: usize = 10_000_000;
//
// let mut rng = WyHash::seed_from_u64(471_093);
//
...
// const N: usize = 10_000_000;
//
// let mut rng = WyHash::seed_from_u64(739_139);
//
// let mut sampler = DynamicAliasMethodSampler::with_capacity(6);
//
// assert!(sampler.sample(&mut rng).is_none());
...
// const N: usize = 10_000_000;
//
// let mut rng = WyHash::seed_from_u64(248_971);
//
// let mut sampler = DynamicAliasMethodSampler::with_capacity(6);
//
// assert!(sampler.sample(&mut rng).is_none());
