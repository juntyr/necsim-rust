use necsim_core::cogs::{Habitat, MathsCore, Rng};
...
#[contract_trait]
pub trait InMemoryDispersalSampler<M: MathsCore, H: Habitat<M>, G: Rng<M>>:
...
#[contract_trait]
impl<M: MathsCore, H: Habitat<M>, G: Rng<M>, T: InMemoryDispersalSamplerNoError<M, H, G>>
