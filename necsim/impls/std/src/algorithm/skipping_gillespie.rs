...
pub struct GillespieAlgorithm<
    ...
    I: ImmigrationEntry,
> where
    O::DispersalSampler: SeparableDispersalSampler<H, StdRng>,
{
    habitat: H,
    rng: StdRng,
    lineage_store: L,
    ...
    coalescence_sampler: ConditionalCoalescenceSampler<H, InMemoryLineageReference, L>,
    turnover_rate: O::TurnoverRate,
    speciation_probability: O::SpeciationProbability,
    event_sampler: ConditionalGillespieEventSampler<
        H,
        StdRng,
    ...
    active_lineage_sampler: GillespieActiveLineageSampler<
        ...
        X,
        O::DispersalSampler,
        ConditionalCoalescenceSampler<H, InMemoryLineageReference, L>,
        O::TurnoverRate,
        O::SpeciationProbability,
    ...
    O::DispersalSampler: SeparableDispersalSampler<H, StdRng>,
{
    ...
    type CoalescenceSampler =
        ConditionalCoalescenceSampler<H, Self::LineageReference, Self::LineageStore>;
    type Error = O::Error;
    type EventSampler = ConditionalGillespieEventSampler<
        H,
        Self::Rng,
        Self::LineageReference,
        Self::LineageStore,
