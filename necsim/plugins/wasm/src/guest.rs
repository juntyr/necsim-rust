...
fn map_bridge_option_pair_result(
    ...
    >,
) -> Result<Option<(de::Out, de::Out)>, DeError> {
    match result {
...
fn map_bridge_enum_result(
    result: Result<
        ...
        serde_wasm_host::DeError,
    >,
) -> Result<(de::Out, VariantAccess), DeError> {
    match result {
        Ok((handle, variant)) => {
            let handle: wit_bindgen_rust::Handle<DeValue> =
                unsafe { wit_bindgen_rust::Handle::from_raw(handle.handle) };
...
impl From<DeError> for serde_wasm_guest::DeErrorHandle {
...
impl<'de> de::EnumAccess<'de> for EnumAccess {
    fn erased_variant_seed(
        &mut self,
        d: &mut dyn de::DeserializeSeed<'de>,
    ) -> Result<(de::Out, de::Variant<'de>), DeError> {
        ...
        let erased_variant = de::Variant {
            ...
            unit_variant: {
                unsafe fn unit_variant(a: any::Any) -> Result<(), DeError> {
                    let variant = a.take::<VariantAccess>();

                    variant
                        .inner
                        .unit_variant()
                        .map_err(|err| DeError { inner: err })
                }
                unit_variant
            },
            visit_newtype: {
...
impl<'de> de::Deserializer<'de> for Deserializer {
    fn erased_deserialize_any(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
    ...
    fn erased_deserialize_u8(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
        map_bridge_result(self.inner.erased_deserialize_u8(v.into()))
    }

    fn erased_deserialize_u16(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
        map_bridge_result(self.inner.erased_deserialize_u16(v.into()))
    }

    fn erased_deserialize_u32(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
        map_bridge_result(self.inner.erased_deserialize_u32(v.into()))
    }

    fn erased_deserialize_u64(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
        map_bridge_result(self.inner.erased_deserialize_u64(v.into()))
    }

    fn erased_deserialize_i8(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
        map_bridge_result(self.inner.erased_deserialize_i8(v.into()))
    }

    fn erased_deserialize_i16(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
        map_bridge_result(self.inner.erased_deserialize_i16(v.into()))
    }

    fn erased_deserialize_i32(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
        map_bridge_result(self.inner.erased_deserialize_i32(v.into()))
    }

    fn erased_deserialize_i64(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
    ...
    fn erased_deserialize_f32(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
        map_bridge_result(self.inner.erased_deserialize_f32(v.into()))
    }

    fn erased_deserialize_f64(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
    ...
    fn erased_deserialize_str(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
    ...
    fn erased_deserialize_seq(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
    ...
    fn erased_deserialize_map(&mut self, v: &mut dyn de::Visitor<'de>) -> Result<de::Out, DeError> {
