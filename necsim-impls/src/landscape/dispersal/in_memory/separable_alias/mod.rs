...
pub struct InMemorySeparableAliasDispersal {
...
#[contract_trait]
impl InMemoryDispersal for InMemorySeparableAliasDispersal {
    /// Creates a new `InMemorySeparableAliasDispersal` from the
